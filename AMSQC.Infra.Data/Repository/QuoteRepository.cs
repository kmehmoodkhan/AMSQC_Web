...
namespace AMSQC.Infra.Data.Repository
{
    public class QuoteRepository : IQuoteRepository
    {
        ...
        public Quote GetQuote(int id)
        {
            ...
            var query = _context.Quote.FromSqlRaw("select top 1 VehiclemakeGroup,Vehicle_model,Vehicle_registration,estimate_number from [ama].[vw_Jobs_In_and_Out_QualityCharter] where Estimate_Number = '"+ id + "'").ToList();
